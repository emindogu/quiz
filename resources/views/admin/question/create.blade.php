        ...
        <div class="card-body">
            <form method="post" action="{{route('questions.store',$quiz->id)}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea name="question" class="form-control mt-2" id="" rows="4">{{old('question')}}</textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-success btn-sm btn-block mt-4 form-control">Soru
                        Oluştur</button>
                </div>
            </form>
        </div>
